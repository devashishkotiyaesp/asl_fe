...
import { BodyDataAccumulator, CommonSectionProps, InitValuesProps } from '../types';
import { ReferYourFriendsValidationSchema } from '../validationSchema';
import EditPrivacyPolicy from './EditReferFriends';
...
const CommonSection = ({
  ...
  return (
    <Formik
      ...
      enableReinitialize
      onSubmit={onSubmit}
      validationSchema={ReferYourFriendsValidationSchema({ t })}
    >
