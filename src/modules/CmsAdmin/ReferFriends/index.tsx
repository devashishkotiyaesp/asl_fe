...
const CMSReferFriendsAdmin = () => {
  ...
  const dataFEtch = async () => {
    const response = await getApi(`${REACT_APP_API_URL}/cms-page-section/${id}`, {
      params: { sectionName: KeysEnum.ReferYourFriends, view: true },
    });
    const initialValues = {} as LangueKeyValueProps;
    setResponseData(response.data[KeysEnum.ReferYourFriends]);

    response.data[KeysEnum.ReferYourFriends].forEach(
      ({
        language,
        field_name,
        field_value,
  ...
  return (
    <>
      <PageHeader
        title={t('Cms.ReferFriends.title')}
      ...
      >
        <Breadcrumbs
          items={[
            ...
            {
              label: t('Cms.ReferFriends.title'),
              url: '/',
            },
          ]}
          variant="arrow"
      ...
      <div className="content-base">
        ...
        <Card title={t('Cms.ReferFriends.title')} isGray>
          <CommonSection
...
export default CMSReferFriendsAdmin;
